...
const RenameDialog:React.FC<RenameDialogProps> = ({documentId,children,initialTitle}) => {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    setIsUpdating(true)
    update({ id: documentId, title: title.trim() || "Untitled" }).catch(()=>toast.error("Something went wrong"))
